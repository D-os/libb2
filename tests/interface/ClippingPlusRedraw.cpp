...
void ClippingView::Draw(BRect updateRect)
{
...
void ClippingView::MouseDown(BPoint where)
{
	if (!fFloatingWindow) {
		...
		fFloatingWindow = nullptr;
	}
}

void ClippingView::KeyDown(const char *bytes, int32 numBytes)
{
