...
bool IDLType::HasAttribute(AttributeKind attr) const
{
...
void IDLCommentBlock::AddComment(const SString& comment)
{
  m_comments.add(comment);
}

void IDLCommentBlock::AppendToComment(const SString& more)
{
...
void IDLCommentBlock::Output(const sptr<ITextOutput>& stream, bool startWithTab) const
{
...
void IDLNameType::OutputComment(const sptr<ITextOutput>& stream, bool startWithTab)
{
  if (m_comment != NULL) {
...
bool IDLNameType::HasComment() const
{
...
bool IDLMethod::IsConst() const
{
  return m_const;
}

void IDLMethod::AddTrailingComment(const sptr<IDLCommentBlock>& comment)
{
  m_trailing_comment = comment;
}

void IDLMethod::OutputTrailingComment(const sptr<ITextOutput>& stream) const
{
...
bool IDLMethod::HasTrailingComment() const
{
...
bool InterfaceRec::InNamespace() const
{
...
bool InterfaceRec::HasMultipleBases() const
{
...
void InterfaceRec::OutputComment(const sptr<ITextOutput>& stream, bool startWithTab)
{
  if (m_comment != NULL) {
    m_comment->Output(stream, startWithTab);
  }
...
bool InterfaceRec::is_id_in_use(const SString& id)
{
  SString tmp    = id;
...
bool InterfaceRec::look_in_properties(const SString& id)
{
...
bool InterfaceRec::look_in_methods_and_events(const SString& id)
{
...
bool InterfaceRec::HasAttribute(AttributeKind attr) const
{
  return ((m_attributes & attr) == attr);
}
