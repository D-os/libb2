...
WsdlClass::WsdlClass(const SString& id, const sp<BWsdl>& wsdl)
	:	m_id(id),
		m_wsdl(wsdl)
{
	if (m_wsdl != NULL)
...
ssize_t WsdlClass::AddMethod(const sp<Method>& method)
{
	return m_methods.AddItem(method);
}

ssize_t WsdlClass::AddMemeber(const sp<NamedType>& type)
{
...
ssize_t WsdlClass::AddType(const sp<WsdlType>& type)
{
...
SString type_to_value_string(const sp<NamedType>& type)
{
	SString result;
	bool builtin = true;
...
sptr<Method> create_wsdl_method(const sp<BWsdl>& wsdl, BWsdl::PortType::Operation operation, const SString& url, const SString& urn)
{
...
void sort_classes(SVector< sp<WsdlClass> >& classes)
{
...
status_t create_wsdl_class(const sp<BWsdl>& wsdl, sp<WsdlClass>& obj)
{
...
status_t print_type(const sp<WsdlClass>& obj, const sp<WsdlType>& type, sp<ITextOutput> stream, SSortedVector<SString>& printed)
{
...
status_t wsdl_create_types_header(const sp<WsdlClass>& obj, sp<ITextOutput> stream, const SString& filename)
{
	stream << "/*=============================================================================== */" << endl;
	...
	stream << "#include <utils/Vector.h>" << endl;
	stream << endl;
...
status_t wsdl_create_header(const sp<WsdlClass>& obj, sp<ITextOutput> stream, const SString& filename)
{
	stream << "/*=============================================================================== */" << endl;
	stream << "// " << filename << " is automatically generated by PIDGEN - DO NOT MODIFY" << endl;
	stream << "/*=============================================================================== */" << endl << endl;
...
status_t wsdl_create_cpp(const sp<WsdlClass>& obj, sp<ITextOutput> stream, const SString& filename, const SString& header)
{
	stream << "/*=============================================================================== */" << endl;
	stream << "// " << filename << " is automatically generated by PIDGEN - DO NOT MODIFY" << endl;
	stream << "/*=============================================================================== */" << endl << endl;
...
status_t wsdl_create_types_cpp(const sp<WsdlClass>& obj, sp<ITextOutput> stream, const SString& filename, const SString& header)
{
	stream << "/*=============================================================================== */" << endl;
	stream << "// " << filename << " is automatically generated by PIDGEN - DO NOT MODIFY" << endl;
	stream << "/*=============================================================================== */" << endl << endl;
...
status_t wsdl_create_types_interface(const sp<WsdlClass>& obj, sp<ITextOutput> stream)
{
	stream << "/*========================================================== */ " << endl;
...
status_t wsdl_create_interface(const sp<WsdlClass>& obj, sp<ITextOutput> stream, const SString& typesIdl)
{
	stream << "/*========================================================== */ " << endl;
	stream << "// idl file automatically generated by PIDGEN - DO NOT MODIFY" << endl;
	stream << "/*========================================================== */ " << endl << endl;
