...
{
public:
	BXSDComplexTypeCreator(const sp<BXSDComplexType>& type);
...
{
public:
	BXSDComplexContentCreator(const sp<BXSDComplexContent>& content);
...
{
public:
	BXSDSimpleContentCreator(const sp<BXSDSimpleContent>& schema);
...
{
public:
	BWsdlBindingCreator(const sp<BWsdl::Binding>& wsdl);
...
{
public:
	BWsdlMessageCreator(const sp<BWsdl::Message>& wsdl);
...
{
public:
	BWsdlPortTypeCreator(const sp<BWsdl::PortType>& wsdl);
...
{
public:
	BWsdlServiceCreator(const sp<BWsdl::Service>& wsdl);
...
ssize_t BXMLSchema::AddElement(const sp<BXSDElement>& type)
{
	SAutolock lock(m_lock.Lock());
	return m_elements.AddItem(type);
}

ssize_t BXMLSchema::AddComplexType(const sp<BXSDComplexType>& type)
{
	SAutolock lock(m_lock.Lock());
	return m_complexTypes.AddItem(type);
}

ssize_t BXMLSchema::AddSimpleType(const sp<BXSDSimpleType>& type)
{
	SAutolock lock(m_lock.Lock());
...
ssize_t BXSDComplexType::AddElement(const sp<BXSDElement>& type)
{
	SAutolock lock(m_lock.Lock());
	return m_elements.AddItem(type);
}

ssize_t BXSDComplexType::AddComplexContent(const sp<BXSDComplexContent>& content)
{
	SAutolock lock(m_lock.Lock());
	return m_complexContents.AddItem(content);
}

ssize_t BXSDComplexType::AddSimpleContent(const sp<BXSDSimpleContent>& content)
{
	SAutolock lock(m_lock.Lock());
...
BXMLSchemaCreator::BXMLSchemaCreator(const sp<BXMLSchema>& schema)
	:	m_schema(schema)
{
}

status_t BXMLSchemaCreator::OnStartTag(SString& name, SValue& attributes, sp<BCreator>& newCreator)
{
	SXMLTag tag(name);
...
BXSDComplexTypeCreator::BXSDComplexTypeCreator(const sp<BXSDComplexType>& type)
	:	m_complexType(type)
{
}

status_t BXSDComplexTypeCreator::OnStartTag(SString& name, SValue& attributes, sp<BCreator>& newCreator)
{
	SXMLTag tag(name);
...
BXSDComplexContentCreator::BXSDComplexContentCreator(const sp<BXSDComplexContent>& content)
	:	m_complexContent(content)
{
}

status_t BXSDComplexContentCreator::OnStartTag(SString& name, SValue& attributes, sp<BCreator>& newCreator)
{
	SXMLTag tag(name);
...
BXSDSimpleContentCreator::BXSDSimpleContentCreator(const sp<BXSDSimpleContent>& content)
	:	m_simpleContent(content)
{
}

status_t BXSDSimpleContentCreator::OnStartTag(SString& name, SValue& attributes, sp<BCreator>& newCreator)
{
	return B_OK;
}
...
ssize_t BWsdl::AddBinding(const sp<BWsdl::Binding>& binding)
{
	SAutolock lock(m_lock.Lock());
	return m_bindings.AddItem(binding->Name(), binding);
}

ssize_t BWsdl::AddMessage(const sp<BWsdl::Message>& message)
{
	SAutolock lock(m_lock.Lock());
	return m_messages.AddItem(message->Name(), message);
}

ssize_t BWsdl::AddPortType(const sp<BWsdl::PortType>& port)
{
	SAutolock lock(m_lock.Lock());
	return m_portTypes.AddItem(port->Name(), port);
}

ssize_t BWsdl::AddService(const sp<BWsdl::Service>& service)
{
	SAutolock lock(m_lock.Lock());
...
status_t BWsdlCreator::Parse(const SString& string, const sp<BWsdl>& wsdl)
{
	m_wsdl = wsdl;
...
status_t BWsdlCreator::OnStartTag(SString& name, SValue& attributes, sp<BCreator>& newCreator)
{
	SXMLTag tag(name);
...
BWsdlBindingCreator::BWsdlBindingCreator(const sp<BWsdl::Binding>& binding)
	:	m_binding(binding)
{
}

status_t BWsdlBindingCreator::OnStartTag(SString& name, SValue& attributes, sp<BCreator>& newCreator)
{
...
BWsdlMessageCreator::BWsdlMessageCreator(const sp<BWsdl::Message>& message)
	:	m_message(message)
{
}

status_t BWsdlMessageCreator::OnStartTag(SString& name, SValue& attributes, sp<BCreator>& newCreator)
{
	if (name == "part")
	{
...
BWsdlPortTypeCreator::BWsdlPortTypeCreator(const sp<BWsdl::PortType>& portType)
	:	m_portType(portType)
{
}

status_t BWsdlPortTypeCreator::OnStartTag(SString& name, SValue& attributes, sp<BCreator>& newCreator)
{
...
BWsdlServiceCreator::BWsdlServiceCreator(const sp<BWsdl::Service>& service)
	:	m_service(service),
		m_index(0)
{
}

status_t BWsdlServiceCreator::OnStartTag(SString& name, SValue& attributes, sp<BCreator>& newCreator)
{
	SXMLTag tag(name);
