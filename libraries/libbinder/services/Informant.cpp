...
BInformant::RegisterForCallback(const SValue &                                 key,
                                const os::support::sptr<os::support::IBinder> &target,
                                const SValue &                                 method,
                                uint32_t                                       flags,
                                const SValue &                                 cookie)
{
  ...
  DB(bout << "BInformant::RegisterForCallback ... m_data->callbacks is now:" << endl
          << indent << m_data->callbacks << dedent;)
  return err;
}
                                ...
                                const SValue &        cookie)
{
  ...
  DB(bout << "BInformant::RegisterForCreation ... m_data->creations is now:" << endl
          << indent << m_data->creations << dedent;)
  return err;
}
                                  ...
                                  uint32_t                                       flags)
{
  ...
  DB(bout << "BInformant::UnregisterForCallback ... m_data->callbacks is now:" << endl
          << indent << m_data->callbacks << dedent;)
  return err;
}
                                  ...
                                  uint32_t              flags)
{
  ...
  DB(bout << "BInformant::UnregisterForCreation ... m_data->creations is now:" << endl
          << indent << m_data->creations << dedent;)
  return err;
}
...
BInformant::Inform(const SValue &key, const SValue &information)
{
  ...
  status_t callbacksFound, creationsFound;
  {
    ...
    DB(bout << "BInformant::m_data->callbacks is now:" << endl
            << indent << m_data->callbacks << dedent;)
    DB(bout << "BInformant::m_data->creations is now:" << endl
            << indent << m_data->creations << dedent;)
