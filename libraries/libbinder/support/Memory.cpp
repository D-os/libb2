...
void* IMemory::FastPointer(const sptr<IBinder>& heap, ssize_t offset) const
{
  ...
  if (found)
    ...
    real_heap = IMemoryHeap::AsInterfaceNoInspect(heap);
...
IMPLEMENT_META_INTERFACE(Memory, "org.openbinder.support.IMemory");  // For Eddie
...
IMPLEMENT_META_INTERFACE(MemoryHeap, "org.openbinder.support.IMemoryHeap");  // For Eddie
...
IMPLEMENT_META_INTERFACE(MemoryDealer, "org.openbinder.support.IMemoryDealer");  // For Eddie
