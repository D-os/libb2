...
BProcess::BProcess(team_id tid)
    : m_id(tid), m_lock("BProcess access"), m_pendingHandlers(NULL), m_nextEventTime(B_INFINITE_TIMEOUT), m_maxEventConcurrency(4), m_currentEventConcurrency(0), m_imageLock("BProcess image access"), m_imageData(new ImageData), m_handleRefLock("BProcess handle ref access"), m_remoteRefsReleased(false)
...
void BProcess::PrintBinderReferences(void)
{
}

void BProcess::RestartMallocProfiling(void)
{
}

void BProcess::SetMallocProfiling(bool enabled, int32_t dumpPeriod, int32_t maxItems, int32_t stackDepth)
{
}

void BProcess::RestartVectorProfiling(void)
{
}

void BProcess::SetVectorProfiling(bool enabled, int32_t dumpPeriod, int32_t maxItems, int32_t stackDepth)
{
  (void)enabled;
  (void)dumpPeriod;
  (void)maxItems;
...
void BProcess::RestartMessageIPCProfiling(void)
{
}

void BProcess::SetMessageIPCProfiling(bool enabled, int32_t dumpPeriod, int32_t maxItems, int32_t stackDepth)
{
  (void)enabled;
  (void)dumpPeriod;
  (void)maxItems;
...
void BProcess::RestartBinderIPCProfiling(void)
{
}

void BProcess::PrintBinderIPCProfiling(void)
{
}

void BProcess::SetBinderIPCProfiling(bool enabled, int32_t dumpPeriod, int32_t maxItems, int32_t stackDepth)
{
  (void)enabled;
  (void)dumpPeriod;
  (void)maxItems;
...
void BProcess::CatchHandleRelease(const sptr<IBinder>& remoteObject, catchReleaseFunc callbackFunc)
{
...
void BProcess::UnscheduleHandler(BHandler* handler, bool lock)
{
  ...
  const bool hadRef = ((m_pendingHandlers == handler) || handler->m_prev || handler->m_next);
...
void BProcess::GetRemoteHostInfo(int32_t handle)
{
  (void)handle;
}
...
void BProcess::ExpungeHandle(int32_t handle, IBinder* binder)
{
  SNestedLocker::Autolock _l(m_handleRefLock);
                        ...
                        status_t*         outError)
{
...
#if !LIBBE_BOOTSTRAP
  {
    ...
    if (!found) {
      ...
      // There's no good way of passing args through to the vm also, so pass SValue()
      b  = this->DoInstantiate(context, vmComponentInfo, vmComponentName, vmIDs, SValue(), outError);
...
void BProcess::AtomLeakReport(int32_t mark, int32_t last, uint32_t flags)
{
  SAtom::LeakReport(mark, last, flags);
}
#endif

bool BProcess::ExpungePackage(const wptr<ComponentImage>& image)
{
  bool expunged = false;
