...
#ifndef SUPPORT_STATIC_CPP
#define SUPPORT_STATIC_CPP
...
const sptr<IByteInput>         NullInput(NullStream.get());
const sptr<IByteOutput>        NullOutput(NullStream.get());
