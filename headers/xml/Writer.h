...
#ifndef XML2_B_WRITER_H
#define XML2_B_WRITER_H
...
class BOutputStream : public CXMLOStr
{
 public:
  ...
  virtual status_t StartTag(SString &name, SValueMap &attributes);
...
class BWriter
{
 public:
  ...
  virtual status_t StartTag(const SString &name, const SValueMap &attributes, uint32_t formattingHints = 0);
