...
class BAlignment
{
   public:
	...
	inline BAlignment(alignment horizontal, vertical_alignment vertical);
...
inline BAlignment::BAlignment()
	: horizontal(B_ALIGN_HORIZONTAL_UNSET),
	  vertical(B_ALIGN_VERTICAL_UNSET)
{
}

inline BAlignment::BAlignment(const BAlignment& other)
	: horizontal(other.horizontal),
	  vertical(other.vertical)
{
}

inline BAlignment::BAlignment(alignment horizontal, vertical_alignment vertical)
	: horizontal(horizontal),
	  vertical(vertical)
{
}

inline alignment BAlignment::Horizontal() const
{
	return horizontal;
}

inline vertical_alignment BAlignment::Vertical() const
{
	return vertical;
}
...
inline BAlignment& BAlignment::operator=(const BAlignment& other)
{
	horizontal = other.horizontal;
	vertical   = other.vertical;
	return *this;
