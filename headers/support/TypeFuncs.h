...
B_IMPLEMENT_BASIC_TYPE_FUNCS(u_int8_t)
B_IMPLEMENT_BASIC_TYPE_FUNCS(int16_t)
B_IMPLEMENT_BASIC_TYPE_FUNCS(u_int16_t)
B_IMPLEMENT_BASIC_TYPE_FUNCS(int32_t)
B_IMPLEMENT_BASIC_TYPE_FUNCS(u_int32_t)
B_IMPLEMENT_BASIC_TYPE_FUNCS(int64_t)
B_IMPLEMENT_BASIC_TYPE_FUNCS(u_int64_t)
