...
class BGenericCatalog : public BnCatalog, public storage::BMetaDataNode, public BnIterable
{
 public:
  BGenericCatalog();
...
class BIndexedCatalog : public BnCatalog, public storage::BMetaDataNode, public storage::BIndexedIterable
{
 public:
  BIndexedCatalog();
...
class BCatalog : public BMetaDataCatalog, public storage::SDatumGeneratorInt
{
 public:
  BCatalog();
