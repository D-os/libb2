...
/*!	This class represents a UTF-8 string.  It includes a variety
    ...
    @nosubgrouping
*/
class String : public android::String
{
public:
//	// --------------------------------------------------------------
//	/*!	@name Bookkeeping
...
//	SString 			&UnlockBuffer(int32_t length = -1);
            ...
            //!	Get the SharedBuffer that the SString is using.
...
const TextOutput& operator<<(const TextOutput& io, const String& string);
...
inline void
BSwap(String& v1, String& v2)
{
    v1.swap(v2);
}

inline int32_t
BCompare(const String& v1, const String& v2)
{
