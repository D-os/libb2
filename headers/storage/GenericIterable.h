...
#ifndef STORAGE_GENERICITERABLE_H
#define STORAGE_GENERICITERABLE_H
...
class SSQLBuilder
{
 public:
  ...
  /*!	The default implementation simply returns SValue(), meaning the filters
...
class BGenericIterable : public BnIterable, public SSQLBuilder
{
 ...
 public:
  ...
  virtual sptr<IIterator> NewIterator(const SValue& args = SValue(), status_t* error = NULL);
  //@}
...
#endif /* STORAGE_GENERICITERABLE_H */
