...
#ifndef SUPPORT_BYTESTREAM_INTERFACE_H
#define SUPPORT_BYTESTREAM_INTERFACE_H
...
{
 public:
  DECLARE_META_INTERFACE(ByteInput)
...
{
 public:
  DECLARE_META_INTERFACE(ByteOutput)
...
{
 public:
  DECLARE_META_INTERFACE(ByteSeekable)
...
#endif /* SUPPORT_BYTESTREAM_INTERFACE_H */
