...
#ifndef SUPPORT_ASSOCIATIVEVECTOR_H
#define SUPPORT_ASSOCIATIVEVECTOR_H
...
template <class KEY, class VALUE>
inline SKeyedVector<KEY, VALUE>::SKeyedVector()
    : m_undefined(VALUE())
{
}

template <class KEY, class VALUE>
inline SKeyedVector<KEY, VALUE>::SKeyedVector(const VALUE& undef)
    : m_undefined(undef)
{
}

template <class KEY, class VALUE>
inline SKeyedVector<KEY, VALUE>::SKeyedVector(const SSortedVector<KEY>& keys,
...
/*!	This is functionally the same as an = operator.  The =
	...
	call SetTo(). */
template <class KEY, class VALUE>
inline void SKeyedVector<KEY, VALUE>::SetTo(const SKeyedVector<KEY, VALUE>& o)
{
  m_keys      = o.m_keys;
  m_values    = o.m_values;
  m_undefined = o.m_undefined;
}
...
template <class KEY, class VALUE>
inline void SKeyedVector<KEY, VALUE>::SetCapacity(size_t total_space)
{
  m_keys.setCapacity(total_space);
  m_values.setCapacity(total_space);
}

/*!	This is like SetCapacity(), but sets the amount of
	space beyond the number of items currently in the vector. */
template <class KEY, class VALUE>
inline void SKeyedVector<KEY, VALUE>::SetExtraCapacity(size_t extra_space)
{
  m_keys.SetExtraCapacity(extra_space);
  m_values.SetExtraCapacity(extra_space);
}
...
/*!	This will be >= CountItems() -- the difference is the number
	...
	yet used. */
template <class KEY, class VALUE>
inline size_t SKeyedVector<KEY, VALUE>::Capacity() const
{
  return m_keys.capacity();
}

template <class KEY, class VALUE>
inline size_t SKeyedVector<KEY, VALUE>::CountItems() const
{
  return m_keys.size();
}
...
template <class KEY, class VALUE>
inline const VALUE& SKeyedVector<KEY, VALUE>::ValueFor(const KEY& key, bool* found) const
{
...
*/
template <class KEY, class VALUE>
inline const VALUE& SKeyedVector<KEY, VALUE>::FloorValueFor(const KEY& key, bool* found) const
{
  return *(const VALUE*)FloorKeyedFor(&key, found);
}

template <class KEY, class VALUE>
inline const VALUE& SKeyedVector<KEY, VALUE>::CeilValueFor(const KEY& key, bool* found) const
{
...
template <class KEY, class VALUE>
inline VALUE& SKeyedVector<KEY, VALUE>::EditValueFor(const KEY& key, bool* found)
{
  return *(VALUE*)EditKeyedFor(&key, found);
}

template <class KEY, class VALUE>
inline const KEY& SKeyedVector<KEY, VALUE>::KeyAt(size_t i) const
{
  return m_keys.itemAt(i);
}

template <class KEY, class VALUE>
inline const VALUE& SKeyedVector<KEY, VALUE>::ValueAt(size_t i) const
{
  return m_values.itemAt(i);
}

template <class KEY, class VALUE>
inline VALUE& SKeyedVector<KEY, VALUE>::EditValueAt(size_t i)
{
  return m_values.editItemAt(i);
}

template <class KEY, class VALUE>
inline const SSortedVector<KEY>& SKeyedVector<KEY, VALUE>::KeyVector() const
{
  return m_keys;
}

template <class KEY, class VALUE>
inline const SVector<VALUE>& SKeyedVector<KEY, VALUE>::ValueVector() const
{
  return m_values;
}

template <class KEY, class VALUE>
inline SVector<VALUE>& SKeyedVector<KEY, VALUE>::ValueVector()
{
  return m_values;
}

template <class KEY, class VALUE>
inline ssize_t SKeyedVector<KEY, VALUE>::IndexOf(const KEY& key) const
{
  return m_keys.indexOf(key);
}

template <class KEY, class VALUE>
inline ssize_t SKeyedVector<KEY, VALUE>::FloorIndexOf(const KEY& key) const
{
  return m_keys.FloorIndexOf(key);
}

template <class KEY, class VALUE>
inline ssize_t SKeyedVector<KEY, VALUE>::CeilIndexOf(const KEY& key) const
{
  return m_keys.CeilIndexOf(key);
}

template <class KEY, class VALUE>
inline bool SKeyedVector<KEY, VALUE>::GetIndexOf(const KEY& key, size_t* index) const
{
...
template <class KEY, class VALUE>
inline ssize_t SKeyedVector<KEY, VALUE>::AddItem(const KEY& key, const VALUE& value)
{
  return AddKeyed(&key, &value);
}

template <class KEY, class VALUE>
inline void SKeyedVector<KEY, VALUE>::RemoveItemsAt(size_t index, size_t count)
{
...
template <class KEY, class VALUE>
inline ssize_t SKeyedVector<KEY, VALUE>::RemoveItemFor(const KEY& key)
{
  return RemoveKeyed(&key);
}

template <class KEY, class VALUE>
inline void SKeyedVector<KEY, VALUE>::MakeEmpty()
{
  m_keys.clear();
  m_values.clear();
}
...
template <class KEY, class VALUE>
inline void SKeyedVector<KEY, VALUE>::Swap(SKeyedVector<KEY, VALUE>& o)
{
...
template <class KEY, class VALUE>
inline void BSwap(SKeyedVector<KEY, VALUE>& v1, SKeyedVector<KEY, VALUE>& v2)
{
  v1.Swap(v2);
}
...
#endif /* SUPPORT_ASSOCIATIVEVECTOR_H */
