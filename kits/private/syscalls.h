...
extern status_t		_kern_entry_ref_to_path(int reffd, const char *leaf,
                        char *userPath, size_t pathLength);
extern status_t		_kern_normalize_path(const char* userPath,
                        bool traverseLink, char* buffer);
extern int			_kern_open_entry_ref(int reffd, const char *leaf,
...
extern status_t		_kern_create_dir_entry_ref(int reffd, const char *leaf,
                        int perms);
